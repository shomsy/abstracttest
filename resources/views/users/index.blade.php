...
<head>
    ...
    <link
        rel="canonical"
        href="https://www.creative-tim.com/product/now-ui-dashboard-pro"
    />
    ...
    <meta
        itemprop="name"
        content="Now Ui Dashboard PRO by Creative Tim"
    >
    <meta
    ...
    />
    <link
        href="{{ asset('assets') }}/css/now-ui-dashboard.css?v=1.3.0"
        rel="stylesheet"
    />
...
<body class="sidebar-mini clickup-chrome-ext_installed">
            ...
            <div class="dropdown show-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="adjustments-line">
                        ...
                        >
                            <div class="badge-colors text-center">
                                <span
                                    class="badge filter badge-yellow"
                                    data-color="yellow"
                                ></span>
                                <span
                                    class="badge filter badge-blue"
                                    data-color="blue"
                                ></span>
                                <span
                                ...
                                ></span>
                                <span
                                    class="badge filter badge-orange active"
                                    data-color="orange"
                                ></span>
                                <span
                    ...
                    <li class="button-container">
                        <a
                            href="https://www.creative-tim.com/product/now-ui-dashboard-laravel"
                            target="_blank"
                            class="btn btn-primary btn-block btn-round"
                        >Download
                            Now</a>
                        <a
                            href="https://now-ui-dashboard-laravel.creative-tim.com/docs/getting-started/laravel-setup.html"
                            target="_blank"
                        ...
                        <a
                            href="https://www.creative-tim.com/product/now-ui-dashboard-pro-laravel?ref=nud-free-upgrade-live"
                            target="_blank"
                            class="btn btn-primary btn-block btn-round"
                        >
                    ...
                    <li class="button-container text-center">
                        ...
                        <a
                            class="github-button"
                            href="https://github.com/creativetimofficial/now-ui-dashboard"
    ...
    <script src="{{ asset('assets') }}/js/plugins/perfect-scrollbar.jquery.min.js">
    </script>
    <!--  Google Maps Plugin    -->
